  ...
  return (
    ...
    >
      <div className="container-page py-12">
        <div className="grid gap-10 md:grid-cols-4">
          ...
          <div className="md:col-span-2">
            <div className="flex items-center gap-2.5">
              <span className="flex size-7 items-center justify-center rounded-md bg-white/20 text-[11px] font-bold text-white">
                CCS
              </span>
              <span className="text-sm font-semibold text-white">{SOCIETY.fullName}</span>
            </div>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2.5 text-sm">
              {NAV_LINKS.slice(0, 6).map((l) => (
                <li key={l.to}>
                  <Link href={l.to} className="text-white/65 transition-colors hover:text-white">
                    {l.label}
                  </Link>
                </li>
              ))}
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2.5 text-sm">
              ...
              <li className="text-white/65 text-xs leading-relaxed">{SOCIETY.location}</li>
              <li className="pt-1">
                <Link
                  href="/recruitment"
        ...
        {/* Bottom bar */}
        <div className="mt-10 flex flex-col items-start justify-between gap-2 border-t border-white/10 pt-6 text-xs text-white/35 md:flex-row md:items-center">
          <p>© {new Date().getFullYear()} {SOCIETY.fullName}. All rights reserved.</p>
